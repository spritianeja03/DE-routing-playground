  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-all duration-150 ease-in-out focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        outline:
          "border border-input-border bg-transparent shadow-sm hover:shadow-md active:shadow-inner-sm active:translate-y-px hover:bg-accent hover:text-accent-foreground", // Neumorphic outline
        secondary:
          "bg-secondary text-secondary-foreground shadow-sm hover:shadow-md active:shadow-inner-sm active:translate-y-px", // Neumorphic secondary
        ghost: "hover:bg-accent hover:text-accent-foreground", // Ghost can remain flat
        link: "text-primary underline-offset-4 hover:underline", // Link can remain flat
      },
      size: {
