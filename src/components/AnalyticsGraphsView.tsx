...
export function AnalyticsGraphsView({
  successRateHistory,
  volumeHistory,
  merchantConnectors, // Destructure merchantConnectors
}: AnalyticsGraphsViewProps) {
  return (
    <div className="space-y-6 h-full flex flex-col">
      <SuccessRateOverTimeChart data={successRateHistory} merchantConnectors={merchantConnectors} />
      <VolumeOverTimeChart data={volumeHistory} merchantConnectors={merchantConnectors} />
