...
export function SankeyDiagram({ data }: SankeyDiagramProps) {
  if (data && data.nodes.length > 0) {
    return (
      <div className="h-full flex flex-col items-center justify-center bg-muted/20 rounded-lg p-4 text-center"> {/* Removed Card, using div with similar styling */}
  ...
  return (
    <div className="h-full flex flex-col items-center justify-center bg-muted/20 rounded-lg p-4"> {/* Removed Card, using div with similar styling */}
      <h2 className="text-xl font-semibold mb-1">Live Transaction Flow</h2>
